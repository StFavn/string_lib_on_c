...
#define actual(str1, str2) s21_strcspn(str1, str2)
#define expected(str1, str2) strcspn(str1, str2)
...
static const char *str2_vals_fail[] = {
    "XYZ",   // 0
    "7890",  //
    "\t"     //
};
...
// These tests raise Segmentation fault in standart strcspn
...
Suite *suite_s21_strcspn() {
  Suite *suite = suite_create("suite_s21_strcspn");
