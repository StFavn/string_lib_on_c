...
START_TEST(simple_int) {
  char str1[BIG_BUFF_SIZE];
  char str2[BIG_BUFF_SIZE];
...
Suite *suite_s21_sprintf_ext(void) {
  Suite *s = suite_create("suite_s21_sprintf_ext");

  TCase *tc = tcase_create("sprintf_extra");
